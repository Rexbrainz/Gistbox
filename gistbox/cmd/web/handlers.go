...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	// Check that both email and password are provided, and also check the
	// format of the email address as a UX-nicety (incase of user typo)
	form.CheckField(validator.NotBlank(form.Email), "email", "This fied cannot be blank")
	form.CheckField(validator.Matches(form.Email, validator.EmailRX), "email", "This field must be a valid email address")
	form.CheckField(validator.NotBlank(form.Password), "password", "This is field cannot be blank")
