...
// Valid() returns true if the FieldErrors map does not contain any entries.
...
// AddNonFieldError() is a helper for adding error messages to 
// the NonFieldErrors slice.
